        ...
        <div style={styles.list}>
          {reminders.map(r => (
            <div key={r.id} style={styles.item}>
              ...
              {(r.response_text || r.responseText) && <p style={{ fontSize: '12px', margin: '4px 0 6px', padding: '6px 10px', background: '#fff3cd', border: '1px solid #ffc107', borderRadius: '5px', color: '#856404', fontWeight: '600' }}>Previous: {r.response_text || r.responseText}</p>}
