            ...
            <div style={{ ...styles.reportSection, marginBottom: 0, padding: '12px' }}>
              ...
              <div style={{ display: 'flex', gap: '6px', alignItems: 'flex-end', flexWrap: 'wrap' }}>
                <div style={{ flex: '1', position: 'relative', minWidth: '130px' }}>
                  ...
                  <input value={paperOrderSearch} onChange={e => { setPaperOrderSearch(e.target.value); setShowOrderDropdown(true) }} onFocus={() => setShowOrderDropdown(true)} onBlur={() => setTimeout(() => setShowOrderDropdown(false), 200)} placeholder="Order No..." style={{ padding: '6px', border: '1px solid #ddd', borderRadius: '4px', fontSize: '11px', width: '100%', boxSizing: 'border-box' }} disabled={paperOrderNo.length >= 5} />
